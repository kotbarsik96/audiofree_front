...
import AFTabs from '~/components/_UI/Tabs/AFTabs.vue'
import AFTab from '~/components/_UI/Tabs/AFTab.vue'
import AFSpoiler from '~/components/_UI/AFSpoiler.vue'
import ProductDescription from '~/components/_UI/ProductDescription.vue'
import ProductInfo from '~/components/_UI/ProductInfo.vue'
